...
export default {
  props: {
    projectType: {
      type: String,
      default: "normal" //normal 代表普通医院项目，beauty代表医疗美容项目
    }
  },
  data() {
    return {
            ...
            return h("div", [
              ...
              h(
                "Button",
                {
                  ...
                  class: {
                    menuHide:
                      (this.menuShow(this.AM.Jur.unLookUser) &&
                        params.row.admin.isLock) ||
                      (this.menuShow(this.AM.Jur.lookaUser) &&
                        !params.row.admin.isLock)
                  },
                  style: {
                    marginRight: "5px"
  ...
  methods: {
    ...
    getData() {
      ...
      API.Jurisdiction.listUser(copyData)
        .then(res => {
          if (this.projectType != "normal") {
            res.data.forEach((element, index) => {
              if (element.admin.username == "admin") {
